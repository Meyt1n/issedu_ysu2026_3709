...
- **今日**：时段氛围英雄卡（任务进度环 + 滚动统计）+ 今日照护任务（确认 / 延期 / 跳过，跳过必填原因，完成反馈 Toast + 触觉震动，全部完成有彩带庆祝）+ **季节健康资讯小卡片**（家庭服务器白名单结果或虚构本地季节日历，明确来源/时间，可带标题与来源进入助手草稿）+ 近 7 天完成趋势图 + 待关注风险 + 最近变化时间线；入口可进入**语音助手**（联机后连接家庭服务器/电脑后端）；
