...
down_revision: Union[str, None] = "0003_hct102_authorization_security"
...
def upgrade() -> None:
    ...
    op.create_unique_constraint("uq_health_event_idempotency_key", "health_event", ["idempotency_key"])
    op.create_index("ix_health_event_idempotency_key", "health_event", ["idempotency_key"])
