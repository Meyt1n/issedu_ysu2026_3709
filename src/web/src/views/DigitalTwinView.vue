...
<template>
  <section class="page-hero twin-hero">
    <div><p class="eyebrow"><AppIcon name="sparkle" :size="13" /> FAMILY DIGITAL TWIN</p><div class="title-line"><h2 class="hero-greeting gradient-text">家庭数字孪生</h2><span><i /> 本地语义空间</span></div><p class="hero-subtitle">将家庭档案、聊天记忆与本地知识投影到同一张可追踪的 RAG 语义星系。</p></div>
  </section>
...
.twin-hero{padding-bottom:9px}.hero-subtitle{color:var(--ink-faint);font-size:10px;line-height:1.5;margin:6px 0 0}.twin-galaxy-only :deep(.galaxy-card){height:calc(100vh - 197px)}
</style>
