...
const ICONS: Record<string, string> = {
  ...
  droplet: '<path d="M12 3.8s-5 5.7-5 9.2a5 5 0 0 0 10 0c0-3.5-5-9.2-5-9.2Z"/><path d="M9.5 14.5a2.7 2.7 0 0 0 2.5 1.7"/>',
  ...
  thermometer: '<path d="M14.5 15.5V6a2.5 2.5 0 0 0-5 0v9.5a4.5 4.5 0 1 0 5 0Z"/><path d="M12 10.5v6"/>',
  wind: '<path d="M3.5 8.5h10a2.5 2.5 0 1 0-2.5-2.5"/><path d="M3.5 12h15a2.5 2.5 0 1 1-2.5 2.5"/><path d="M3.5 15.5h7"/>',
  ...
  stop: '<rect x="7" y="7" width="10" height="10" rx="1.2"/>',
  rewind: '<path d="m11 6-7 6 7 6V6ZM20 6l-7 6 7 6V6Z"/>',
