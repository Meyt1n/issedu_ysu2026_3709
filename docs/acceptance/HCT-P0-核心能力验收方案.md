...
实现 PR：[PR #336](https://github.com/Meyt1n/issedu_ysu2026_3709/pull/336)
...
`PUBLISHED_AUXILIARY_ONLY` 发布，不代表正式固定集、正式模型质量或 R3 验收通过；HCT-206 的 HCT-201/HCT-205
真实批准前置也不能替代外部证据。P0 总体仍需外部证据目录、正式模型、真实天气和 R3 签署齐全后才能整体验收。
