...
4. [`docs/vibe-coding/PR任务关联与Codex Review工作流.md`](docs/vibe-coding/PR任务关联与Codex%20Review工作流.md)
...
每个 PR 必须绑定一个 GitHub Issue、一个 Story 和对应 FR/NFR。Codex Review 或人工 Review 必须按[PR 任务关联与 Codex Review 工作流](docs/vibe-coding/PR任务关联与Codex%20Review工作流.md)核对任务完成度、验收证据和 P0/P1/P2 风险。CI 通过不等于任务完成；高风险授权、健康事件、删除、规则、模型、知识和隐私变更必须等待第二名人工复核。
